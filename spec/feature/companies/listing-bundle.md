...
[[spec/feature/companies/README.md]] §3.5 (listing クロール) を拡張し、[[spec/feature/companies/gbizinfo.md]] (中小レーンの権威ソース) と接続する。
...
| `structured` (API) | gBizINFO | `gov-api` | CLI | 決定論 | 中小の網羅・従業員数の権威 ([[spec/feature/companies/gbizinfo.md]]) |
...
(将来 gBizINFO は `corporate_number` を第 2 dedup キーに持つ — [[spec/feature/companies/gbizinfo.md]] §2。)
...
- **B (follow-up / enrich 段)**: gBizINFO 従業員数で権威的に上書き確定 ([[spec/feature/companies/gbizinfo.md]])。
...
- **gBizINFO enrich (中小 B)**: 従業員数で `is_smb`/`size` を権威確定 ([[spec/feature/companies/gbizinfo.md]])。
