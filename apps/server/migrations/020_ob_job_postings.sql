-- migration 020: OB求人投稿 + ES添削相談リクエスト
-- IMMUTABLE: 適用済 SQL は書き換えず、変更は 021_*.sql 以降で追記する。
...
CREATE INDEX IF NOT EXISTS idx_ob_job_postings_active  ON ob_job_postings(is_active) WHERE is_active IS TRUE;
